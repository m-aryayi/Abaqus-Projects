...
mdb.Job(name='JobPhaseArray-1', model=modelName, description='', type=ANALYSIS, 
...
# mdb.jobs['JobPhaseArray-1'].submit(consistencyChecking=OFF)
# mdb.jobs['JobPhaseArray-1'].waitForCompletion()
...
# odb = visualization.openOdb(path= 'JobPhaseArray-1.odb')
...
# time_values = output.data[:, 0]
# output_values = output.data[:, 1]

# a.instances['Part-1-1'].nodes[0].coordinates
